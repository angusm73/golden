...
require './inc/header.php'; ?>
    ...
    <!-- Main Nav -->
    <nav class="main-nav">
        <a href="/" data-spy=".hero" class="active">Home</a>
        <a href="/story" data-spy=".story">Story</a>
        <a href="/contact" data-spy=".contact">Contact</a>
        <a href="/skills" data-spy=".skills">Skills</a>
        <a href="/portfolio" data-spy=".portfolio">Portfolio</a>
    </nav>
    ...
    <div class="hero">
        ...
        <p><span>I'm a 20 year old web-developer with 8 years experience.<br>
            My programming passion started back in 2010.<br>
            I started at Ulladulla Web Design in 2014 where I worked on <a
                href="https://southernphone.com.au" target="_blank"
                rel="noopener">Southern Phone</a>, <a
                href="https://youcamp.com" target="_blank" rel="noopener">Youcamp</a>,
            <a href="https://varrassopr.com" target="_blank" rel="noopener">Varrasso
                PR</a> &amp; much more.<br>
            Now in 2018 I am on my own, building web experiences out of this
            world!</span>
        </p>
        <div class="buttons">
        ...
        <div class="links">
            <a href="https://github.com/angusm73" target="_blank" rel="noopener">
    ...
    <!-- Story -->
    <div class="blue-row">
        <div class="feature-box story">
            <h1>My Story</h1>
            <h2>Angus' Timeline</h2>
            <ul class="timeline">
                <li>
        ...
        <div class="feature-box skills">
            ...
            <ul class="list">
                <li tabindex="0">
                    <span>Dev-ops</span>
                    <div class="expand">
                        <p>I make developers lives easier and more enjoyable.</p>
                    </div>
                </li>
                <li tabindex="0">
                    <span>Custom Web Applications</span>
                    <div class="expand">
                        <p>I build custom websites.</p>
                    </div>
                </li>
                <li tabindex="0">
                    <span>Laravel</span>
                    <div class="expand">
                        <p>Experienced with Laravel.</p>
                    </div>
                </li>
                <li tabindex="0">
                ...
                <li tabindex="0">
                    ...
                    <div class="expand">
                        <p>Experienced with various aspects of front end
                            development</p>
                    </div>
                </li>
                <li tabindex="0">
                    <span>PHP</span>
                    <div class="expand">
                        <p>Experienced in development &amp; server admining</p>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <!-- Previous Work -->
    <div class="purple-row">
        <div class="feature-box portfolio">
            <h1>Portfolio</h1>
            <h2>Projects I have worked on</h2>
            <ul class="list">
                <li tabindex="0">
                    <a href="https://southernphone.com.au" target="_blank" rel="noopener">
                        Southern Phone
                    </a>
                    <div class="expand">Visit Southern Phone</div>
                </li>
                <li tabindex="0">
                    <a href="https://youcamp.com" target="_blank" rel="noopener">
                        Youcamp
                    </a>
                    <div class="expand">Visit Youcamp</div>
                </li>
                <li tabindex="0">
                    <a href="https://crossfithuey.com.au" target="_blank" rel="noopener">
                        CrossFit Huey
                    </a>
                    <div class="expand">Visit CrossFit Huey</div>
                </li>
                <li tabindex="0">
                    <a href="https://flairr.io" target="_blank" rel="noopener">
                        flairr.io
                    </a>
                    <div class="expand">Visit Flairr.io</div>
                </li>
                <li tabindex="0">
                    <a href="https://gitlab.com/angusmoore73" target="_blank" rel="noopener">
                        Inline CMS
                    </a>
                    <div class="expand">View inline CMS</div>
                </li>
                <li tabindex="0">
                    <span>
                        <a href="https://gitlab.com/angusmoore73/Image-Cropper"
                            target="_blank" rel="noopener">Image Cropper</a>
                    </span>
                    <div class="expand">View image cropper</div>
                </li>
            </ul>
        </div>
    </div>
