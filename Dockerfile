...
RUN apt-get install -y -force-yes=yes curl

# Install PHP 5.6
RUN apt-get install -y php5.6 php5.6-mysql php5.6-mcrypt php5.6-mbstring php5.6-cli php5.6-gd php5.6-curl php5.6-xml
